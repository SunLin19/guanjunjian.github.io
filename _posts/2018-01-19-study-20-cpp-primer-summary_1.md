...
> 包括第1至7章
> 
> [第1章 开始] [第2章 变量和出本类型] [第3章 字符串、向量和数组] [第4章 表达式] [第5章 语句] [第6章 函数] [第7章 类]
> 
> 第五版 
>
...
-   5种用于程序调试很有用的名字，可以参考[《C和指针》笔记 14.1][14]
...
-   把函数名作为一个值使用时，该函数自动地转换成指针，可以参考[《C和指针》笔记 13.3][14]
